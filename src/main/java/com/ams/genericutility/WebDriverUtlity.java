...
import org.openqa.selenium.JavascriptExecutor;
	...
	*/
	...
	/**
	* it's an implicitly wait Always wait for 
	Element in DOM document & release the control if 
	element available 
	* @param driver
	*/
	...
	/**
	* it's an Explicitly wait Always wait for Page 
	to be loaded & available in GUI
	* @param driver
	...
	*/
	...
	/**
	* used to Switch to Alert Window & click on OK 
	button
	* @param driver
	*/
	...
	/**
	* used to Switch to Alert Window & click on 
	Cancel button
	* @param driver
	*/
	...
	*/
	...
	/**
	* used to Switch to Frame Window based on id or 
	name attribute
	* @param driver
	...
	*/
	...
	/**
	* used to select the value from the dropDwon 
	based on index
	* @param driver
	* @param index
	*/
	...
	/**
	* used to select the value from the dropDwon 
	based on value / option avlaible in GUI
	* @param element
	* @param value
	*/
	...
	/**
	* used to place mouse cursor on specified 
	element
	* @param driver
	* @param elemnet
	*/
